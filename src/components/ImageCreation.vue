...
const previewImage: Ref<File | null> = ref(null);
const isPreviewImage: Ref<boolean> = computed(() => {
  return previewImage.value === null ? false : true;
});
...
<template>
  <div class="image-wrapper">
    ...
    <div v-show="previewImage" class="preview-image-container">
      <img :src="previewImage" class="uploaded-image" />
      <RefreshIcon class="refresh" @click="previewImage = null" />
    </div>
  </div>
</template>
